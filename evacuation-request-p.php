          ...
          <div class="container">
            <div class="section">
              <div class="row">
                <div class="col s12">
                  <div class="right">
                        <a href="evacuation-requests" class="btns btns-delete waves-effect waves-teal" style="color: white !important">
              ...
              <div class="row">
                ...
                <div class="col l4 m4 s12">
                    <div class="card">
                        <div class="card-content" style="min-height: 750px;">
                            <h6 class="header uppercase blue-grey-text center">Prepared Bags</h6>
                            <?php
                                $sno = 1;
                                $currencyIcon = '';
                                $sql = "SELECT * FROM evacuationpreparations WHERE evacuation_id = '$get_id' ORDER BY id DESC";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<tr>
                                            <td>' . $sno++ . '</td>
                                            <td>'. $sealNumber .'</td>
                                            <td>'. $currencyIcon.number_format($row['total_amount'])  .'</td>
                                        </tr>';
                                    }
                                    echo '</tbody>
                                    </table>';
