...
class Process
{
	...
	*/
	function procLogin(){
		global $session, $form;
		/* Login attempt */
		// url is now stored as $_POST['location'] (posted from login.php). 
		//If it's blank, let's ignore it. Otherwise, let's do something with it.
		$redirect = NULL;
		if($_POST['location'] != '') {
			$redirect = $_POST['location'];
		}
		$retval = $session->login(strtolower($_POST['user']), $_POST['pass'], $_POST['location'], isset($_POST['remember']));
	...
	*/
	function procRegister(){
		...
		$retval = $session->register($_POST['user'], $_POST['phoneno'], $_POST['pass'], $_POST['email']);
