                                    ...
                                    <div class="row margin">
                                        <div class="input-field col l3 m3 s12">
                                            <select id="sealNumber" class="searchableSelect" required>
                                                ...
                                                <?php getListOfCashAllocatableBagsInSupCustody($signed_location_id); ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row margin">
                                            <div class="input-field col l6 m6 s12">
                                                <select id="allocatedTo" class="searchableSelect" required>
                                            ...
                                            <div class="input-field col l6 m6 s12">
                                                <select id="workstation" class="searchableSelect" required>
