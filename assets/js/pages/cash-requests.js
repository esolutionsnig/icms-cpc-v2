jQuery(document).ready(function($) {
    ...
    $(".proceedToCashAllocation").click(function(event) {
        ...
        if (erName == '' || clientBranch == '' || clientBranchL == '' || clientBranchLC == '' || consignmentLocation == '') {
            ...
            $.ajax({
                ...
                method: "POST",
                data: { sendER: 1, erName: erName, erSlug: erSlug, bankId:bankId, consignmentLocation:consignmentLocation, clientBranchLC: clientBranchLC, clientBranch:clientBranch, clientBranchL: clientBranchL, username: username, usertoken: usertoken },
    ...
    $(".updateEvacuationRequest").click(function(event) {
        ...
        var clientBranchLC = ''
        var consignmentLocation = $("#consignmentLocation").val()
        if (erId == '' || erName == '' || clientBranch == '' || clientBranchL == '' || consignmentLocation == '') {
            ...
            $.ajax({
                url: "app/pf/evacuation-requests.php",
                method: "POST",
                data: { updateER: 1, erId: erId, erName: erName, erSlug: erSlug, bankId:bankId, consignmentLocation:consignmentLocation, clientBranchLC: clientBranchLC, clientBranch:clientBranch, clientBranchL: clientBranchL, username: username, usertoken: usertoken },
                success: function(data) {
