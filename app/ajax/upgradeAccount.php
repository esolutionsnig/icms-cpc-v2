...
?>
            ...
            <div class="modal-body">
                <div class="row">
                	<div class="col-md-6">
                    	<h2>Change User Account Level</h2>
                    	<hr />
                        <form class="form-horizontal" novalidate method='post' action="sys/ajax/updateaccount.php">
                                	...
                                	<div style="border-bottom: 1px solid #333;">
                                    	<select name="ulevel" id="ulevel" class="form-control levelinfo">
                                            ...
                                            <option value="7">Moderator</option>
                                          	<option value="6">Contestant</option>
                            ...
                            <div class="col-md-6">
                            	<input type="hidden" name="username" id="username" value="<?php echo $user_id; ?>">
                               	<button type="submit" class="btn btn-success upaccounts" id="btn-profile">
                               		<i class="fa fa-save"></i> UPDATE ACCOUNT LEVEL
                               	</button>
                          	</div>
                    	</form>
