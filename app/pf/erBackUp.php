...
// Preannouncement
// if(isset($_POST["addPreannouncement"])){
...
//     } else if (strlen($sealNumber) < 16) {
//         $error = true;
//         echo'Invalid Seal Number';
//     }
//     if (alreadyTaken('cash_preparations', 'seal_number', $sealNumber)) {
//         $error = true;
//         echo 'Seal Number Already Exists';
//     }

//     if( !$error ) {
//         addPreannouncement($evReqId, $sealNumber, $depositType, $categoryType, $containerType, $username, $addedOn);
//         // addPreannouncementSN($evReqId, $sealNumber, $depositType, $categoryType, $containerType, $username, $addedOn);
//     }
// }

// Add Preannouncement function Client Request
// function addPreannouncement($evReqId, $sealNumber, $depositType, $categoryType, $containerType, $username, $addedOn)
// {
//     require('../core/db.php');
...
//     $con->close();
// }
// Add Preannouncement function Seal Number Generation
// function addPreannouncementSN($evReqId, $sealNumber, $depositType, $categoryType, $containerType, $username, $addedOn)
// {
//     require('../core/db.php');
//     $sql = "INSERT INTO seal_numbers (seal_number, container_type_id, deposit_type_id, category_id, added_by, added_on)
//         VALUES ('$sealNumber', '$containerType', '$depositType', '$categoryType', '$username', '$addedOn')";
