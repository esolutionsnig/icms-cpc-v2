...
if(isset($_POST["sendER"])){
    ...
    $dateOfExecution                 = filter_var($_POST['dateOfExecution'], FILTER_SANITIZE_STRING);
    ...
    if (empty($dateOfExecution)) {
        $error = true;
        echo'Invalid Execution Date';
    }

    if( !$error ) {
        sendEvacReq($erName, $bankId, $clientBranch, $clientBranchL, $clientBranchLC, $consignmentLocation, $dateOfExecution, $erSlug, $username, $addedOn);
    }
}
// Add Evacaution Request function
function sendEvacReq($erName, $bankId, $clientBranch, $clientBranchL, $clientBranchLC, $consignmentLocation, $dateOfExecution, $erSlug, $addedBy, $addedOn)
{
    require('../core/db.php');
    // require_once('../core/general-functions.php');

    $sql = "INSERT INTO evacuations (er_name, bank_id, branch_id, location_code, consignment_location_id, er_slug, client_rep, updatedOn, date_execution)
            VALUES ('$erName', '$bankId', '$clientBranch', '$clientBranchL', '$consignmentLocation', '$erSlug', '$addedBy', '$addedOn', '$dateOfExecution')";
    ...
    if ($con->query($sql) === true) {
        ...
        $to = 'e.ibeh@icms.ng';
        $subject = 'New Evacuation Request From:'.$clientName;
                                    ...
                                    <tr>
                                        <td class="bg_white email-section">
                                            <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                                <span class="subheading">New Evacuation Request From:</span>
                                                <h2>'.$clientName.'</h2>
                                                <p> The above-stated client has requested for cash evacuation. The evacuation is set to be carried out on '.$dateOfExecution.'.
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Date of Execution: <strong>'.$dateOfExecution.'</strong></li>
...
if(isset($_POST["updateER"])){
    ...
    $clientBranch	 	    = filter_var($_POST['clientBranch'], FILTER_SANITIZE_STRING);
    $erSlug                 = filter_var($_POST['erSlug'], FILTER_SANITIZE_STRING);
    $dateOfExecutione                 = filter_var($_POST['dateOfExecutione'], FILTER_SANITIZE_STRING);
    ...
    if (empty($dateOfExecutione)) {
        $error = true;
        echo'Invalid Execution Date';
    }

    if( !$error ) {
        updateEvacReq($erId, $erName, $bankId, $clientBranch, $clientBranchL, $clientBranchLC, $consignmentLocation, $dateOfExecutione, $erSlug, $username, $addedOn);
    }
}
// Update Evacaution Request function
function updateEvacReq($erId, $erName, $bankId, $clientBranch, $clientBranchL, $clientBranchLC, $consignmentLocation, $dateOfExecutione, $erSlug, $username, $addedOn)
{
    require('../core/db.php');
    ...
    client_rep = '$username',
    updatedOn = '$addedOn',
    date_execution = '$dateOfExecutione'
    WHERE id = '$erId' ";
    if ($con->query($sql) === true) {
        echo "rsent";
...
if(isset($_POST["addDollarCashAllocation"])){
    ...
    if( !$error ) {
        addDollarCashAllocation($bankId, $evReqId, $sealNumber, $depositType, $categoryType, $containerType, $usd, $ucash1000, $ucash1000Amount, $ucash500, $ucash500Amount, $ucash200, $ucash200Amount, $ucash100, $ucash100Amount, $ucash50, $ucash50Amount, $ucash20, $ucash20Amount, $ucash10, $ucash10Amount, $ucash5, $ucash5Amount, $ucash1, $ucash1Amount, $uTotalAmount, $username, $addedOn);
    }
}

// Add Cash Allocation function - Dollar
function addDollarCashAllocation($bankId, $evReqId, $sealNumber, $depositType, $categoryType, $containerType, $usd, $ucash1000, $ucash1000Amount, $ucash500, $ucash500Amount, $ucash200, $ucash200Amount, $ucash100, $ucash100Amount, $ucash50, $ucash50Amount, $ucash20, $ucash20Amount, $ucash10, $ucash10Amount, $ucash5, $ucash5Amount, $ucash1, $ucash1Amount, $uTotalAmount, $username, $addedOn)
{
    require('../core/db.php');
    $sql = "INSERT INTO evacuationpreparations (client_id, evacuation_id, seal_number, container_type_id, deposit_type_id, category_id, currency_id, cash_1000, cash_1000_amount, cash_500, cash_500_amount, cash_200, cash_200_amount, cash_100, cash_100_amount, cash_50, cash_50_amount, cash_20, cash_20_amount, cash_10, cash_10_amount, cash_5, cash_5_amount, cash_1, cash_1_amount, total_amount, client_rep, updatedOn )
        VALUES ('$bankId', '$evReqId', '$sealNumber', '$containerType', '$depositType', '$categoryType', '$usd', '$ucash1000', '$ucash1000Amount', '$ucash500', '$ucash500Amount', '$ucash200', '$ucash200Amount', '$ucash100', '$ucash100Amount', '$ucash50', '$ucash50Amount', '$ucash20', '$ucash20Amount', '$ucash10', '$ucash10Amount', '$ucash5', '$ucash5Amount', '$ucash1', '$ucash1Amount', '$uTotalAmount', '$username', '$addedOn')";
...
if(isset($_POST["addEuroCashAllocation"])){
    ...
    if( !$error ) {
        addEuroCashAllocation($bankId, $evReqId, $sealNumber, $depositType, $categoryType, $containerType, $euro, $ecash1000, $ecash1000Amount, $ecash500, $ecash500Amount, $ecash200, $ecash200Amount, $ecash100, $ecash100Amount, $ecash50, $ecash50Amount, $ecash20, $ecash20Amount, $ecash10, $ecash10Amount, $ecash5, $ecash5Amount, $ecash1, $ecash1Amount, $eTotalAmount, $username, $addedOn);
    }
}

// Add Cash Allocation function - Euro
function addEuroCashAllocation($bankId, $evReqId, $sealNumber, $depositType, $categoryType, $containerType, $euro, $ecash1000, $ecash1000Amount, $ecash500, $ecash500Amount, $ecash200, $ecash200Amount, $ecash100, $ecash100Amount, $ecash50, $ecash50Amount, $ecash20, $ecash20Amount, $ecash10, $ecash10Amount, $ecash5, $ecash5Amount, $ecash1, $ecash1Amount, $eTotalAmount, $username, $addedOn)
{
    require('../core/db.php');
    require('../core/db.php');
    $sql = "INSERT INTO evacuationpreparations (client_id, evacuation_id, seal_number, container_type_id, deposit_type_id, category_id, currency_id, cash_1000, cash_1000_amount, cash_500, cash_500_amount, cash_200, cash_200_amount, cash_100, cash_100_amount, cash_50, cash_50_amount, cash_20, cash_20_amount, cash_10, cash_10_amount, cash_5, cash_5_amount, cash_1, cash_1_amount, total_amount, client_rep, updatedOn )
        VALUES ('$bankId', '$evReqId', '$sealNumber', '$containerType', '$depositType', '$categoryType', '$euro', '$ecash1000', '$ecash1000Amount', '$ecash500', '$ecash500Amount', '$ecash200', '$ecash200Amount', '$ecash100', '$ecash100Amount', '$ecash50', '$ecash50Amount', '$ecash20', '$ecash20Amount', '$ecash10', '$ecash10Amount', '$ecash5', '$ecash5Amount', '$ecash1', '$ecash1Amount', '$eTotalAmount', '$username', '$addedOn')";
...
if(isset($_POST["addCnyCashAllocation"])){
    ...
    if( !$error ) {
        addCnyCashAllocation($bankId, $evReqId, $sealNumber, $depositType, $categoryType, $containerType, $cny, $ycash1000, $ycash1000Amount, $ycash500, $ycash500Amount, $ycash200, $ycash200Amount, $ycash100, $ycash100Amount, $ycash50, $ycash50Amount, $ycash20, $ycash20Amount, $ycash10, $ycash10Amount, $ycash5, $ycash5Amount, $ycash1, $ycash1Amount, $yTotalAmount, $username, $addedOn);
    }
}

// Add Cash Allocation function - Cny
function addCnyCashAllocation($bankId, $evReqId, $sealNumber, $depositType, $categoryType, $containerType, $cny, $ycash1000, $ycash1000Amount, $ycash500, $ycash500Amount, $ycash200, $ycash200Amount, $ycash100, $ycash100Amount, $ycash50, $ycash50Amount, $ycash20, $ycash20Amount, $ycash10, $ycash10Amount, $ycash5, $ycash5Amount, $ycash1, $ycash1Amount, $yTotalAmount, $username, $addedOn)
{
    require('../core/db.php');
    $sql = "INSERT INTO evacuationpreparations (client_id, evacuation_id, seal_number, container_type_id, deposit_type_id, category_id, currency_id, cash_1000, cash_1000_amount, cash_500, cash_500_amount, cash_200, cash_200_amount, cash_100, cash_100_amount, cash_50, cash_50_amount, cash_20, cash_20_amount, cash_10, cash_10_amount, cash_5, cash_5_amount, cash_1, cash_1_amount, total_amount, client_rep, updatedOn )
        VALUES ('$bankId', '$evReqId', '$sealNumber', '$containerType', '$depositType', '$categoryType', '$cny', '$ycash1000', '$ycash1000Amount', '$ycash500', '$ycash500Amount', '$ycash200', '$ycash200Amount', '$ycash100', '$ycash100Amount', '$ycash50', '$ycash50Amount', '$ycash20', '$ycash20Amount', '$ycash10', '$ycash10Amount', '$ycash5', '$ycash5Amount', '$ycash1', '$ycash1Amount', '$yTotalAmount', '$username', '$addedOn')";
    ...
    if ($con->query($sql) === true) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $sql2 = "INSERT INTO cits (evacuation_id, seal_number, vehicle_id, cit_officer_id, delivery_status, added_on, added_by)
...
if(isset($_POST["confirmReceipt"])){
    ...
    if( !$error ) {
        ...
        foreach($sealNumberx as $sealNumber){
            require('../core/db.php');
            // Get Amount Sealed
            $q = " SELECT total_amount FROM evacuationpreparations WHERE seal_number = '$sealNumber' LIMIT 1 ";
            $result = mysqli_query($con, $q);
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $tap = $row['total_amount'];
                }
            }
            confirmCHO($sealNumber, $erId, $tap, $bbCid, $citConfirmationDate, $username, $addedOn);
        }
    }
}

// Confirm Consignment Hand Over function
function confirmCHO($sealNumber, $erId, $tap, $bbCid, $citConfirmationDate, $username, $addedOn)
{
    require('../core/db.php');
    $sql = "UPDATE evacuationpreparations SET 
            is_pickedup = 'YES',
            pickedup_by = '$username',
            pickedup_on = '$citConfirmationDate'
    ...
    if ($con->query($sql) === true) {
        ...
        $sql = "UPDATE cits SET 
            ...
            WHERE cit_officer_id = '$username' AND evacuation_id = '$erId' ";
        if ($con->query($sql) === true) {
            echo "";
        } else {
            echo "Error: " . $sql . "<br>" . $con->error;
...
function getAllEvacuationRequests()
{
    ...
    $sno = 1;
    $sql = "SELECT * FROM evacuations WHERE preannounced = 'NO' ORDER BY er_id DESC";
    $result = $con->query($sql);
...
// Get List Of Seal Numbers
if(isset($_POST["fetchSealNumbersList"])){
    ...
    if (empty($erId)) {
        $error = true;
        echo'Invalid Request UID';
    }

    if( !$error ) {
        fetchSealNumbersList($erId);
    }
}
// Confirm Consignment Hand Over function
function fetchSealNumbersList($erId)
{
    require('../core/db.php');
    $sql = " SELECT DISTINCT seal_number FROM evacuationpreparations WHERE evacuation_id = '$erId' AND is_pickedup = 'NO' ";
    $result = $con->query($sql);
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
...
// Get List Of Seal Numbers
if(isset($_POST["fetchSealNumbersList2"])){
    ...
    if( !$error ) {
        fetchSealNumbersList2($userId);
    }
}
// Confirm Consignment Hand Over function
function fetchSealNumbersList2($userId)
{
    require('../core/db.php');
    $sql = " SELECT DISTINCT seal_number FROM evacuationpreparations WHERE pickedup_by = '$userId' AND is_handed_over = 'NO' ";
    $result = $con->query($sql);
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            //Split and get main seal number
...
// Deliver Consignment
if(isset($_POST["consignmentDelivered"])){
    
    require_once('../core/general-functions.php');
    $addedOn = time();
    $citConfirmationTokenn            = $_POST['citConfirmationTokenn'];
    $username	 	        = filter_var($_POST['username'], FILTER_SANITIZE_STRING);
    $usertoken		        = filter_var($_POST['usertoken'], FILTER_SANITIZE_STRING);
    $client		        = filter_var($_POST['client'], FILTER_SANITIZE_STRING);
    $citConfirmationDate    = date('m/d/y');
    $srbId   = filter_var($_POST['srbId'], FILTER_SANITIZE_STRING);
    $tad   = filter_var($_POST['tad'], FILTER_SANITIZE_STRING);
    ...
    if ( empty($citConfirmationTokenn) ) {
        $error = true;
    ...
    if ( empty($tad) ) {
        $error = true;
        echo 'Invalid Bag Content';
    }

    if( !$error ) {
        consignmentDelivered($srbId, $client, $tad, $username, $addedOn);
    }
}

// Confirm Consignment Hand Over function
function consignmentDelivered($srbId, $client, $tad, $username, $addedOn)
{
    require('../core/db.php');
    $sql = "UPDATE supplybranches SET 
            is_delivered = 'YES',
            is_deliveredOn = '$addedOn',
            is_deliveredBy = '$username'
            WHERE id = '$srbId' AND client = '$client' ";
    if ($con->query($sql) === true) {
        // Update CLient Book Balance
        $sqlbb = "SELECT * FROM bookballances WHERE banks_id = '$client' LIMIT 1 ";
        $resultbb = $con->query($sqlbb);
        if ($resultbb->num_rows > 0) {
            while ($rowbb = $resultbb->fetch_assoc()) {
                $bb_balance = $rowbb['bb_balance'] - $tad ;
                // Update Existing Record
                $sqlu = "UPDATE bookballances SET 
                bb_balance = '$bb_balance',
                last_update = '$addedOn'
                WHERE banks_id = '$client' ";  
                if ($con->query($sqlu) === true) {
                    echo "";
                } else {
                    echo "Error: " . $sqlu . "<br>" . $con->error;
...
if(isset($_POST["processRequest"])){
    ...
    if ( empty($clientName) ) {
        $error = true;
        echo 'Kindly Select a Client';
    }
    if ( empty($startDate) ) {
        $error = true;
        echo 'Kindly Pick a Start Date';
    }
    if ( empty($endDate) ) {
        $error = true;
        echo 'Kindly Pick an End Date';
    }

    if( !$error ) {
        processRequest($clientName, $startDate, $endDate, $username);
    }
}

// Confirm Consignment Hand Over function
function processRequest($clientName, $startDate, $endDate, $username)
{
    require('../core/db.php');
    $sno = 1;
                                $totalAmountPrepared = $totalBagsPrepared = $totalBags = $totalAmount = 0;
                                $sql = "SELECT * FROM evacuations WHERE id = '$clientName' ";
                                $result = $con->query($sql);
                                if ($result->num_rows > 0) {
                                    echo '<div class="card teal lighten-3">
                                    <div class="card-content">';
                                    echo '<div class="row">
                                        <div class="col s12">
                                            <h6 class="black-text uppercase center">Search Result For Date Range: '.$startDate.' &nbsp; &nbsp; <->  &nbsp; &nbsp; ' .$endDate. '</h6>
                                        </div>
                                    </div>';
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        $bankUID = base64_encode($bUID);
                                        //get client name
                                        $reqClientName      = getClientNameByIds($row['id']);
                                        $clientName         = $reqClientName['bank_name'];
                                        //get consignement 
                                        $reqConsLoc             = getConsignmentLocationByIds($row['consignment_location_id']);
                                        $consignmentLocation    = $reqConsLoc['name'];
                            
                                        // Get Total Amount Prepared
                                        $totalAmountPrepared = getTotalAmountPreparedBagsPerRequests($row['er_id']);
                                        // Get Total Bags Prepared
                                        $totalBagsPrepared = getNumberPreparedBagsPerRequests($row['er_id']);
                                        // Get Sum Of All Bags
                                        $totalBags += $totalBagsPrepared;
                                        // Get Sum Of All Amount
                                        $totalAmount += $totalAmountPrepared;
                                        echo '<tr>
                                            <td>' . $sno++ . '</td>
                                            <td><a href="evacuation-request-r?r=' . $row['er_slug'].'cprf'.$bankUID .'" style="color: #504c75 !important;">' . $row['er_name'] . '</a></td>
                                            <td>' . $clientName . '</td>
                                            <td>' . $row['location_code'] . '</td>
                                            <td>'. $consignmentLocation .'</a></td>';
                                            echo '<td><strong>' . number_format($totalBagsPrepared) . '</strong> Bag(s)</td>
                                    ...
                                    echo '</tbody>
                                            ...
                                            <tr>
                                                <th>TOTAL</th>
                                                <th colspan="4">&nbsp;</th>
                                                <th><h4>'.number_format($totalBags).'</h4></th>
                                                <th><h4>'.number_format($totalAmount).'</h4></th>
                                                <th></th>
                                            </tr>
                                        </tfoot>
                                    </table>';
                                  ...
                                  echo '</div>
                                    ...
                                    echo '<div class="row">
                                        <div class="col s12">
                                            <h6 class="black-text uppercase center">Search Result For Date Range: '.$startDate.' &nbsp; &nbsp; <->  &nbsp; &nbsp; ' .$endDate. '</h6>
                                            <p>No record was found. Kindly try again using different search variables.
                                        </div>
                                    </div>';
                                    echo '</div>
                                    </div>';
...
function getTotalAmountPreparedBagsPerRequests($reqId)
{
  // Add DB Connection
  require('../core/db.php');
...
function getNumberPreparedBagsPerRequests($reqId)
{
  // Add DB Connection
  require('../core/db.php');
